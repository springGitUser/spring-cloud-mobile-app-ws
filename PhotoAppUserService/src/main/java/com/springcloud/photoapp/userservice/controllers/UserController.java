...
public class UserController {
	...
	public String greet() {
		return "User Service is Working..." + env.getProperty("local.server.port") + " with token==>"
	...
	@GetMapping("/{userId}")
	public ResponseEntity<UserAlbumResponseDTO> getUserByUserId(@PathVariable String userId) {
		UserAlbumResponseDTO userDetails = userService.getUserById(userId);
		return new ResponseEntity<UserAlbumResponseDTO>(userDetails, HttpStatus.OK);
	}
